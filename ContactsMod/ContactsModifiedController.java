...
public class ContactsModifiedController {
    ...
    public void initialize(){
        students.add(new ContactsModifiedDetails("Maria", "Kate", "maryk@hotmail.com", "+996777079999", "ContactsModifiedApp/profile_img/contact1.jpg"));
        students.add(new ContactsModifiedDetails("John", "Smith", "jsmith@outlook.com", "+996888045555", "ContactsModifiedApp/profile_img/contact2.jpg"));
